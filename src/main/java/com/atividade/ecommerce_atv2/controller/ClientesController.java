...
import com.atividade.ecommerce_atv2.dao.ClientesDAO;
    ...
    public void salvarCliente() {
        try {
            if (clienteSelecionado == null) {
                dao.salvar(new Cliente(txtNome.getText(), txtCpf.getText(), txtTelefone.getText(), txtEmail.getText(), txtEndereco.getText()));
            } else {
                clienteSelecionado.setNome(txtNome.getText());
                clienteSelecionado.setCpf(txtCpf.getText());
                clienteSelecionado.setTelefone(txtEndereco.getText());
